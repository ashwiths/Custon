      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-5">
        <div>
          <h1 className="text-[26px] font-black text-[#252326] dark:text-[#F2D8C2] flex items-center gap-2.5">
            ...
            <span>Target Shortcuts Manager</span>
          </h1>
          <p className="text-xs font-semibold text-[#6B5B54] dark:text-[#A69281] max-w-[650px] leading-relaxed mt-1">
            Manage your custom stealth shortcuts and application hotkeys to hide or close targeted software instantly.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <button
            ...
            className="px-4 py-2.5 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-[#A67165] to-[#734E46] hover:from-[#734E46] hover:to-[#A67165] transition-all shadow-md flex items-center gap-2 border-none cursor-pointer"
          >
            <Plus className="w-4 h-4" />
            <span>Add Target App Shortcut</span>
          </button>
          <button
            onClick={() => {
              setEditingShortcutId(null)
            ...
            className="px-4 py-2.5 rounded-xl text-xs font-bold text-white/80 hover:text-white bg-white/10 hover:bg-white/20 border border-white/15 transition-all cursor-pointer flex items-center gap-2"
          >
            <Power className="w-4 h-4 text-[#A67165]" />
            <span>Create Full Close</span>
          </button>
        </div>
      </div>
